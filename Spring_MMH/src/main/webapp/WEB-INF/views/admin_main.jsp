			...
			<div class='section1-wrap'> <!-- 창너비$(window).innerWidth()(100%) * 창높이 창너비$(window).innerHeight() -->
				...
				<div class='section1-modal'>
					<ul>
						...
						<li><i></i></li>
						<li>
							<a href='javascript:loginkakao();' class='iconBt'><i class='fab fa-facebook-f'></i></a>
							<a href='javascript:logingoogle();' class='iconBt'><i class='fab fa-twitter'></i></a>
						</li>
						...
						<ul>
							<li>
								<ul class='floatclear'>
									...
									<li><a href='javascript:kakaomap();' class='btn-icon-map btn-share'>  <i class='fas fa-globe'></i></a></li>
								</ul>
							</li>
							<li>
								<ul class='floatclear'>
